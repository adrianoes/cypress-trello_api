...
describe('/cards', () => {
    ...
    it('Create a new Card - Negative Test (Bad Request)', { tags: ['NEGATIVE', 'CARD'] }, () => {
        const randomNumber = faker.finance.creditCardNumber()
        cy.createBoard(randomNumber)
        cy.createList(randomNumber)
        cy.readFile(`cypress/fixtures/testdata-${randomNumber}.json`).then(response => {
    ...
    it('Create a new Card - Negative Test (Unauthorized)', { tags: ['NEGATIVE', 'CARD'] }, () => {
        const randomNumber = faker.finance.creditCardNumber()
        cy.createBoard(randomNumber)
        cy.createList(randomNumber)
        cy.readFile(`cypress/fixtures/testdata-${randomNumber}.json`).then(response => {
    ...
    it('Get a Card - Negative Test (Bad Request)', { tags: ['NEGATIVE', 'CARD'] }, () => {
        const randomNumber = faker.finance.creditCardNumber()
        cy.createBoard(randomNumber)
        cy.createList(randomNumber)
        cy.createCard(randomNumber)
    ...
    it('Get a Card - Negative Test (Unauthorized)', { tags: ['NEGATIVE', 'CARD'] }, () => {
        const randomNumber = faker.finance.creditCardNumber()
        cy.createBoard(randomNumber)
        cy.createList(randomNumber)
        cy.createCard(randomNumber)
    ...
    it('Delete a Card - Negative Test (Bad Request)', { tags: ['NEGATIVE', 'CARD'] }, () => {
        const randomNumber = faker.finance.creditCardNumber()
        cy.createBoard(randomNumber)
        cy.createList(randomNumber)
        cy.createCard(randomNumber)
    ...
    it('Delete a Card - Negative Test (Unauthorized)', { tags: ['NEGATIVE', 'CARD'] }, () => {
        const randomNumber = faker.finance.creditCardNumber()
        cy.createBoard(randomNumber)
        cy.createList(randomNumber)
        cy.createCard(randomNumber)
